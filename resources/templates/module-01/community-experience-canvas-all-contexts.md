# Community Experience Canvas — All Contexts

*Workshop 1 — The Experience Is the Community · Open Community Leadership (OCL)*

The eight stages are the same for every community. What changes is where the "door" is, who does the greeting, and what a contribution looks like.

Find your context. If you lead more than one kind of community, fill in more than one column — and pay attention to where your strong column and your weak column don't match. That mismatch is usually your biggest opportunity.
...
> **Repo note:** an auto-welcome (a bot, a `first-interaction` action) is the doormat, not the host. It guarantees nobody arrives to silence — but if no human follows up, it teaches people they were greeted by a robot and then forgotten. Automate the acknowledgement. Keep the response human.
...
> **The second-timer gap:** most maintainers optimise the first contribution and have nothing waiting for the second. The first time is when someone tests the water. The second time is when they're deciding whether to stay. Design for the second-timer and you design for retention. Let contributor behaviour pull your effort: instant acknowledgement for everyone, a human reply for anyone who engages, real investment in the people who come back.
...
*Why would someone come back? What makes this worth returning to?*

| In person | Repo | Online live |
|-----------|------|-------------|
| Why does someone come to the *next* meetup, not just this one? What pulls them back? | Why does a contributor open a second PR? Is there a reason to return, or was it a one-off? | Why does someone join the next sprint? What carries between sessions? |

---

## After mapping

Look across your filled-in stages. Two questions:

1. **Where's the gap?** Which stage is weakest — where are you losing people?
2. **Who solved it?** If you're in a mixed room: find someone whose community works nothing like yours. What's one thing they do well that you could borrow?

The maintainer's weak Welcome might be the meetup organiser's strongest stage. The meetup's weak Return might be something a project solved years ago. The person who fixed your problem is often sitting three tables over.
